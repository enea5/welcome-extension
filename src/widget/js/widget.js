  ...
  global.initWidget = function (options, URL, Ajax) {
    ...
    function media_events(data){
       ...
       if (!data.collection_url){
         redirect_link = `https://theconversation.social/c/${data.link_id}`
	   } else {
    ...
    var onScroll = function (e) {
      ...
      if ((window.innerHeight + window.pageYOffset) >= document.body.offsetHeight && scrollTimer == null && document.querySelector('.social-curation').querySelectorAll('li.social-curation__hidden').length > 0) {
