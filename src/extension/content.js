...
function htmlTooltipOnDefaultTwitterCard (twitterId) {
  const bioHtml = `
      <div style="display: none; padding: 5px; font-size: 75%; letter-spacing: 3px; font-family: system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Helvetica Neue, sans-serif !important;">
        <div style="text-align: center; margin-bottom: 5px;">
          <strong>SOCIAL INTELLIGENCE BRIEF</strong>
...
function putSubcategory(elem, qtipElem, twitterId) {
  fetchCategoryCached(twitterId, function (displayData) {
    if (displayData !== null) {
      ...
      $(`<div class='icategory' style="position: absolute; right: 29px; top:1px; font-family:system-ui;font-size: 11px; text-transform: capitalize; zcolor: #9ca2a7; color: #a6b5c1; font-weight:${fontWeight}; max-width:27ch; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${displayData}</div>`).insertBefore(elem.find('.hasTooltip').parent())
        .each(function () {
