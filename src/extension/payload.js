...
function emptyCollectionTitleTwitterLoad() {
    ...
    var target = document.querySelector("main h2[role=\"heading\"][dir=\"auto\"]");
    if (!target) {
        //The twiiter container node not loaded yet. Wait 25ms and try again
        window.setTimeout(emptyCollectionTitleTwitterLoad, 25);
        return;
    }
    var collection_decription = document.querySelector("main section[role=\"region\"] > div h1[role=\"heading\"][dir=\"auto\"] + div + div")
    if( collection_decription ){
      ...
      var collection_selector = document.querySelector("main h2[role=\"heading\"][dir=\"auto\"]").innerHTML = "";
...
function addHeaders(collection_dict) {
	$("a > time").each(function (i, element) {
      ...
      if($("h2[aria-level='2']").hasClass("r-18jsvk2")){
        contentClass = "r-18jsvk2";
      }
    ...
    "></div>
    <div class="css-1dbjc4n r-1j3t67a r-1w50u8q" style="padding-top:15px; padding-bottom:15px; padding-left: 15px;">
      <div dir="auto" class="css-901oao r-1fmj7o5 r-1qd0xha r-1b6yd1w r-b88u0q r-ad9z0x r-bcqeeo r-qvutc0"><span class="css-901oao css-16my406 r-1qd0xha r-b88u0q r-ad9z0x r-bcqeeo r-qvutc0"><span class="css-901oao css-16my406 r-1qd0xha r-ad9z0x r-bcqeeo r-qvutc0"><span class="css-901oao css-16my406 r-1qd0xha r-ad9z0x r-bcqeeo r-qvutc0 ${contentClass}">What ${role} Are Saying </span></span></div>
    </div>
    <div class="" style="
    height: 10px;
  ...
  chrome.storage.local.get('tw_backgroundColor', async function (result) {
   ...
   if (TW_BACKGROUND != "rgb(255, 255, 255)"){
      ...
      if (TW_BACKGROUND == "rgb(0, 0, 0)"){
        ...
        var target = document.querySelector("main section[role=\"region\"] > div h1[role=\"heading\"][dir=\"auto\"] + div")
        ...
        var collection_decription = document.querySelector("main section[role=\"region\"] > div h1[role=\"heading\"][dir=\"auto\"] + div + div")
        if( collection_decription ){
          var collection_selector = document.querySelector("main h2[role=\"heading\"][dir=\"auto\"]");
